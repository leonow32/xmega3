...
// ========================================
	...
	// Interface selection
	#define		SSD1309_USE_I2C					0
	#define		SSD1309_USE_SPI					1
	...
	// Pinout for SPI
	#if SSD1309_USE_SPI
		#define		SSD1309_CHIP_SELECT_INIT	VPORTC.DIR |=  PIN3_bm
		#define		SSD1309_CHIP_SELECT			VPORTC.OUT &= ~PIN3_bm
		#define		SSD1309_CHIP_DESELECT		VPORTC.OUT |=  PIN3_bm
		#define		SSD1309_DC_INIT				VPORTD.DIR |=  PIN4_bm
		#define		SSD1309_DC_DATA				VPORTD.OUT |=  PIN4_bm
		#define		SSD1309_DC_COMMAND			VPORTD.OUT &= ~PIN4_bm
	#endif
